...
class DaftarModel extends Model
{
    ...
    protected $allowedFields = ['nama', 'ttl', 'pekerjaan', 'alamat', 'telpon', 'jenis_kendaraan', 'kode_kendaraan', 'instruktur', 'paket', 'jadwal', 'status', 'pembayaran', 'harga', 'buktiTF', 'kehadiran', 'created_at', 'updated_at'];
