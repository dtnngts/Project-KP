...
<form action="/regis" method="post" enctype="multipart/form-data" id='form-daftar'>
    ...
    <div class="container" id="formDaDir">
        <div class="card1">
            ...
            <button type="button" style="place-items:right;" class="btn btn-secondary" id="Daftar"></button>
        </div>
    </div>
</form>
